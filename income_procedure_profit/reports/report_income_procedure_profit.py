...
class ReportIncomeByProcedure(models.AbstractModel):
    _name = 'report.income_procedure_profit.report_income_procedure_profit'
    ...
    def get_report_values(self, docids, data=None):
        ...
        final_records, detailed_list, total_count, total_income, total_cost, total_profit  = self.get_income_procedure(start_date, end_date, treatment_list, doctor, detailed, company_id)
