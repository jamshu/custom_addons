...
class SalesReportWizard(models.TransientModel):
    ...
    def pharmacy_sales_report(self):
        ...
        return self.env.ref('pharmacy_cost_profit_report.pharmacy_cost_profit_report').report_action(self, data=data)


class ReportSale(models.AbstractModel):
    _name = 'report.pharmacy_cost_profit_report.pharmacy_report_pdf'
    ...
    def get_active_orders(self, period_start=False, period_stop=False,
        ...
        s_domain = [
            ...
            ('date_invoice', '<=', period_stop), ('is_pharmacy', '=', True),
            ('state', 'in', ('open', 'paid')),
    ...
    def get_sale_details(self, period_start=False, period_stop=False, show_drug=False, pdt_ids=False, company_id=False):
        ...
        journal_ids = journal_obj.search([
            ('use_pharmacy', '=', True), ('company_id', '=', company_id[0])])
        jrnl_data = {}
